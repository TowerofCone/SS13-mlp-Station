...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("infraction")
				soundin = pick('sound/voice/beepsky/criminal.ogg', 'sound/voice/beepsky/justice.ogg', 'sound/voice/beepsky/freeze.ogg')
			if ("aj_law")
				soundin = pick('sound/voice/beepsky/aj/god.ogg', 'sound/voice/beepsky/aj/iamthelaw.ogg', 'sound/voice/beepsky/aj/secureday.ogg', 'sound/voice/beepsky/aj/radio.ogg', 'sound/voice/beepsky/aj/insult.ogg', 'sound/voice/beepsky/aj/creep.ogg')
			if ("aj_infraction")
				soundin = pick('sound/voice/beepsky/aj/criminal.ogg', 'sound/voice/beepsky/aj/justice.ogg', 'sound/voice/beepsky/aj/freeze.ogg')
			if("honkbot_e")
