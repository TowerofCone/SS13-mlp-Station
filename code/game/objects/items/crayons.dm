...
/obj/item/toy/crayon
	...
	var/static/list/graffiti = list("amyjon","face","matt","revolution","engie","guy","end","dwarf","uboa","body","cyka","star","poseur tag","prolizard","antilizard","pinkie_cm","fluttershy_cm","applejack_cm","twilight_cm","rarity_cm","rainbow_cm","iwtcird","minuette","trixie_cm","starlight_cm","luna_cm","celestia_cm","amethyst")
